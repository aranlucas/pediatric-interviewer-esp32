/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2cbe8e6b2c4bb5154faf444ef52eb755)
// Runtime types generated with workerd@1.20260815.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	...
	WEB_ORIGINS: string;
	PEDIATRIC_INTERVIEWER: DurableObjectNamespace<import("./src/index").PediatricInterviewer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PediatricInterviewer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEVICE_TOKEN" | "GEMINI_API_KEY" | "WEB_TOKEN_SECRET" | "WEB_ORIGINS">> {}
}
