/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fa3e0d88f8eee3be56bc90fbcb9af87c)
...
interface __BaseEnv_Env {
  ...
  ANGRY_CAT: DurableObjectNamespace<import("./src/index").AngryCat>;
  PEDIATRIC_INTERVIEWER: DurableObjectNamespace<import("./src/index").PediatricInterviewer>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/index");
    durableNamespaces: "AngryCat" | "PediatricInterviewer";
  }
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, "WEATHER_LOCATION" | "WEATHER_LATITUDE" | "WEATHER_LONGITUDE">
  > {}
}
